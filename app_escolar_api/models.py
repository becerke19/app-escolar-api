...
class Materias(models.Model):
    ...
    dias_json = models.JSONField(default=dict, blank=True)  # {"lunes": true, "martes": false, ...}
    ...
    profesor = models.ForeignKey(Maestros, on_delete=models.CASCADE, null=False, blank=False, related_name='materias_impartidas')
